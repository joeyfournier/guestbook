...
public class Subscription {
  ...
  */
  ...
  public String flag; // can flag development subscriptions, empty for production?
   ...
   **/
  public Subscription(String aid, MarketPlace mp, Person person, Company comp, Order ord , String stat, Map<String,User> us) {
    this();
    accountId = aid;
    marketPlace = mp;
    creator = person;
